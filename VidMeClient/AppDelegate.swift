...
//        WebService.sharedInstance.authUser(username: "BorisZinkovich", password: "Rbtd02101996")
    ...
    func applicationDidBecomeActive(_ application: UIApplication) {
        ...
        if ((WebService.sharedInstance.user != nil) && (WebService.sharedInstance.user?.accessToken.isValid() == false))
        {
            _ = WebService.sharedInstance.authUser(user: WebService.sharedInstance.user!)
        }
    }
